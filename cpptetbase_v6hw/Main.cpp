...
int main(int argc, char *argv[]) {
  ...
  board->accept(key);
  drawScreen(board->get_oScreen(), board->get_wallDepth()); cout << endl; //디버깅 위해서 부모클래스 어떻게 쌓이는지
  drawScreen(board->get_oCScreen(), board->get_wallDepth()); cout << endl; //자식꺼 어떻게 쌓이는지
